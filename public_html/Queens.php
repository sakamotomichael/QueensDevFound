...
<div class="container-fluid">
            ...
            <div class="row demo-3">
                <div class="col-lg-12">
                    <div id="large-header" class="large-header">
                        ...
                        <h1 class="main-title" style="background:rgba(0,0,150,0.3);"><b>Developers' Foundation</b><br/>Queen's
                            Chapter</span></h1>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-10 col-md-offset-1">
            ...
            <div class="row"> <!--Picture and description row-->
                <div class="col-lg-6 text-center"> <!--Image column-->
                    <img src="Granthall.JPG"
                         style="border:2px solid black; border-radius: 5px; margin-top: 10px; margin-bottom: 10px;"
                         class="img-responsive center-block">
                </div> <!--Close Image column-->

                <div class="col-lg-6"> <!-- Description column-->
                    <div class="col-lg-10"
                         style="font-size:150%; font-family:'JosefinSans Regular'; text-align:justify;padding-top:20px;padding-bottom:20px;">
                        <h2><b>Every company deserves to be recognized</b></h2>
                        <br/>
                        <p> We're a team of students and aspiring web designers which serve as a subteam for Developers'
                            Foundation. </p>
                        <p> In charge of operations at Queen's University and the city of Kingston, we primarily seek
                            out NPOs in the city and assist them in establishing an online presence.
                        </p>
    ...
    <div class="row WhatWeDo"
         style="padding-bottom:40px;background:url(wwdbackground2.jpg);background-repeat: no-repeat; background-size:cover;background-position:center;">
        <!--WhatWeDo section-->
            ...
            <div class="row" style="padding-bottom:20px;"> <!--3 panels section-->
                ...
                <div class="col-md-10 col-md-offset-1"> <!--3 panels offset-->
                    ...
                    <div class="col-lg-4  col-md-12 col-sm-12 col-xs-12"><!--EstablishAConnection Section-->
                        ...
                        <div
                            style="background:rgba(255,255,255,0.9);border-style:solid;border-color:blue;border-radius:25px;margin-top:10px;margin-bottom:10px;height:100%;"
                            id="panel1">
                            ...
                            <div class="WWDtext row" style="margin-left:5px;margin-right:5px;">
                                <div class="col-lg-10 col-md-offset-1" style="text-align:justify;">
                                    <p> If you're an NPO, we're here to help you establish an online presence for little
                                        to no cost. </p>
                                    <p>We would love to help you. Contact us and we can get you started. </p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4  col-md-12 col-sm-12 col-xs-12"><!--We create your website Section-->
                        ...
                        <div
                            style="background:rgba(255,255,255,0.9);border-style:solid;border-color:yellow;border-radius:25px;margin-top:10px;margin-bottom:10px;"
                            id="panel2">
                            ...
                            <div class="WWDtext row" style="margin-left:5px;margin-right:5px;">
                                <div class="col-lg-10 col-md-offset-1" style="text-align:justify;">
                                    ...
                                    <p> We'll be in constant contact with you to ensure that you have the perfect
                                        website that your NPO deserves. </p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4  col-md-12 col-sm-12 col-xs-12"><!--YourSiteWillBeHosted Section-->
                        ...
                        <div
                            style="background:rgba(255,255,255,0.9);border-style:solid;border-color:red;border-radius:25px;margin-top:10px;margin-bottom:10px;"
                            id="panel3">
                            ...
                            <div class="WWDtext row" style="margin-left:5px;margin-right:5px;">
                                <div class="col-lg-10 col-md-offset-1" style="text-align:justify;">
                                    <p> The website we create for you will be hosted using Heroku, with no initial or
                                        monthly costs.
                                    </p>
...
<div class="row Portfolio" style="font-family:'JosefinSans Regular'; background:url(light_wool.png);">
    <!--Portfolio section-->
...
<div class="row Contact"
     style="font-family:'JosefinSans Regular'; padding-bottom:40px;background:url(formbackground4.jpg);background-repeat: no-repeat;background-size:cover;">
    <!--ContactUS Section-->
    ...
    <div class="col-lg-8 col-md-8 col-md-offset-2">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1 style="font-size:350%; padding-bottom:20px; color:white;text-shadow: 1px 0 0 #CCC, 0 -1px 0 #CCC, 0 1px 0 #CCC, -1px 0 0 #CCC;">
                    <b>Send us a message - let's initiate a connection.</b></h1>
            </div>
        </div>
        ...
        <div class="row" style="background:url(cream_dust.png);border-radius:25px;">
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-8  col-md-8 col-md-offset-2">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 text-center"
                                 style="padding-top:10px;padding-bottom:10px;">
                                <button type="button" class="formbutton btn btn-lg" id="studentbutton">A Student
                                </button>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form action="" class="mainWrap npoForm form-email" method="post" data-form-type="nob">
                            <input placeholder="Name of the NPO you represent" type="text"
                                   class="name form-input-name"/>
                ...
                <div class="row" style="padding-bottom:40px;">
                    <div class="col-lg-12 text-center">
                        <p class="moreInfo" style="font-size:150%;color:black;">You can also visit the <a
                                href="https://developersfoundation.ca" target="_blank">main Developers' Foundation
                                website</a> for more information about Developers' Foundation in general.</p>
                    </div>
                </div>
            </div>
        </div>
